...
void sha256_final(SHA256_CTX *ctx, unsigned char hash[])
{
	...
	//Padded alles was noch im Puffer liegt.
	if(ctx->datalen < 56){
		ctx->data[i++] = 0x80;
		while(i < 56)
			ctx->data[i++] = 0x00;
	...
	//Fuegt die gesamte Messagelänge an das Padding und transformiert es.
